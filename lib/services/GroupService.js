...
var GroupService = /** @class */ (function () {
    ...
    GroupService.prototype.listGroups = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var groupId, group, groups, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        groupId = parseInt(id);
                        return [4 /*yield*/, prisma.group.findUnique({
                                where: {
                                    id: groupId,
                                },
                            })];
                    ...
                    case 2: return [4 /*yield*/, prisma.group.findMany()];
                    case 3:
                        groups = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, prisma.group.update({
                                where: {
                                    id: parseInt(id),
                                },
                                data: group,
    ...
    GroupService.prototype.deleteGroup = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var deletedGroup, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, prisma.group.delete({
                                where: {
                                    id: parseInt(id),
                                },
                            })];
